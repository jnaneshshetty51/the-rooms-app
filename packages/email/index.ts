...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL ?? process.env.EMAIL_FROM ?? 'stay@therooms.in';
...
export async function sendCheckInReminder(params: {
  ...
  return sendEmail({
    ...
    react: React.createElement(CheckInReminderEmail, {
      ...params,
      hotelAddress: params.hotelAddress ?? 'The Rooms, 103/2, Uniworld, Neeladri Road, Behind Karnataka Bank, Electronic City Phase 1, Bangalore, Karnataka 560100',
      hotelPhone: params.hotelPhone ?? '+91 73490 47799',
