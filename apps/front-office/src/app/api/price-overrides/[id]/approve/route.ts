// apps/front-office/src/app/api/price-overrides/[id]/approve/route.ts
// Approve Price Override Request
...
import { z } from 'zod';
import { approvePriceOverride, getPriceOverrideById } from '@the-rooms/db/queries/priceOverrideQueries';
...
const approvePriceOverrideSchema = z.object({
    finalOverriddenPrice: z.number().positive().optional(),
...
export async function POST(
    ...
    try {
        ...
        const parsed = approvePriceOverrideSchema.safeParse(body);
        ...
        const result = await approvePriceOverride(id, {
            approvedById: userId!,
        ...
        await createAuditLog({
            ...
            metadata: {
                ...
                finalOverriddenPrice: finalOverriddenPrice ?? existingRequest.overriddenPrice.toNumber(),
                notes,
            },
        ...
        console.error('[PRICE_OVERRIDE_APPROVE]', error);
