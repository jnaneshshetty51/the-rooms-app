    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
            <div className="text-center max-w-md">
                <div className="w-16 h-16 rounded-full bg-[#E17055]/10 flex items-center justify-center mx-auto mb-4">
                ...
                <h1 className="text-2xl font-bold text-[#2D3436] mb-2">You're Offline</h1>
                ...
                <p className="text-xs text-[#636E72] mt-8">
                    Guest Portal - The Rooms
                </p>
            </div>
        </div>
    );
