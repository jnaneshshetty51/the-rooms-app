// apps/admin/src/app/api/rooms/board/route.ts
// Admin Room Board API - Uses same logic as front-office but with ADMIN role check
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.error("[ADMIN_ROOMS_BOARD] Error:", error);
